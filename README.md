...
이 프로젝트는 OWASP Top 10 2025의 주요 항목 중 하나인 'A02: 보안 설정 미흡(Security Misconfiguration)'을 탐지하기 위한 보안 진단 도구입니다. 

웹 서버의 HTTP 응답 헤더를 분석하여 발생 가능한 공격 벡터를 식별하고, 위험도별 해결 방안을 제시합니다.
